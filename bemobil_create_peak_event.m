% bemobil_create_peak_event() - Inserts events for peak events like eyeblinks or heartbeats, based on the activity of a
...
%
% Usage:
%   >>  [ ALLEEG EEG CURRENTSET ] = bemobil_create_peak_event(ALLEEG, EEG, CURRENTSET, component_to_use, event_name, refractory_period)
%   >>  [ ALLEEG EEG CURRENTSET ] = bemobil_create_peak_event(ALLEEG, EEG, CURRENTSET, component_to_use, event_name, refractory_period, out_filename, out_filepath)
%
% Inputs:
...
function [ ALLEEG EEG CURRENTSET ] = bemobil_create_peak_event(ALLEEG, EEG, CURRENTSET, component_to_use, event_name, refractory_period, out_filename, out_filepath)
...
while timepoint<=length(component_activity)
    ...
    if component_activity(timepoint)>threshold
        ...
        maximum_timepoint = starting_timepoint +...
