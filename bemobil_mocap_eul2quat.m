...
%
% Input arguments:
%       EEG dataset containing mocap channels with eul data (must have 3 eul channels with labels containing
%       "eul_x/y/z")
%
%
% Output argument:
...
assert(EEG_mocap_in.nbchan == 6,'Rigidbody eul angle dataset needs to have exactly 6 channels: XYZ position and XYZ orientation.')
