function plot = bemobil_plot_ERSPs(average_time_frequency_data,  all_subjects_time_frequency_data, STUDY, ALLEEG)
...
% grand average maximum
scale = max(max(abs(average_time_frequency_data.grand_average.ersp)));
n_subplots = 1;
n_ERSPs = 1;
